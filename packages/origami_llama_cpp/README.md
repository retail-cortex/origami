...
The `origami-llama-cpp` package provides offline, local edge LLM routing executing quantized GGUF models (Meta Llama 3.1 8B, Gemma 4 26B, Mistral NeMo 12B) via the `llama-cpp-python` C++ bindings.
